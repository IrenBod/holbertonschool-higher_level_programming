#!/usr/bin/python3
"""
This module defines the class MyList, which
inherits from the built-in list class
and adds a method to print the list in sorted order.

The MyList class provides an additional method
`print_sorted`, which prints
...
class MyList(list):
    """
    A subclass of the built-in list that provides an
